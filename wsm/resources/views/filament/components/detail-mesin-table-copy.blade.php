@php
    $pemilik = data_get(is_string($mesin->owner_name) ? json_decode($mesin->owner_name, true) : $mesin->owner_name, 'name', 'Tidak diketahui');
...
<div class="dc-container">
    ...
    <div class="dc-panel panel-left">
        ...
        <div class="neon-text text-level">Lv. {{ $tingkat }}</div>
